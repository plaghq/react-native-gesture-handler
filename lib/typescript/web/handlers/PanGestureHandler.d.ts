...
export default class PanGestureHandler extends GestureHandler {
    ...
    protected onPointerUp(event: AdaptedEvent, sourceEvent?: TouchEvent | PointerEvent): void;
    protected onPointerRemove(event: AdaptedEvent, sourceEvent?: TouchEvent | PointerEvent): void;
    protected onPointerMove(event: AdaptedEvent, sourceEvent?: TouchEvent | PointerEvent): void;
    protected onPointerOutOfBounds(event: AdaptedEvent, sourceEvent?: TouchEvent | PointerEvent): void;
    private shouldActivate;
    private shouldFail;
    private tryBegin;
    private checkBegan;
    activate(force?: boolean): void;
    fail(_sendIfDisabled?: boolean): void;
