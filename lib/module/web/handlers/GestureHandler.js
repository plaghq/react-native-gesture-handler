...
export default class GestureHandler {
  ...
  onPointerDown(event, _sourceEvent) {
  ...
  onPointerAdd(event, _sourceEvent) {
    if (this.config.needsPointerData) {
      this.sendTouchEvent(event);
    }
  }

  onPointerUp(event, _sourceEvent) {
    if (this.config.needsPointerData) {
      this.sendTouchEvent(event);
    }
  ...
  onPointerRemove(event, _sourceEvent) {
    if (this.config.needsPointerData) {
      this.sendTouchEvent(event);
    }
  }

  onPointerMove(event, _sourceEvent) {
  ...
  onPointerLeave(event, _sourceEvent) {
  ...
  onPointerEnter(event, _sourceEvent) {
    if (this.config.needsPointerData) {
      this.sendTouchEvent(event);
    }
  }

  onPointerCancel(event, _sourceEvent) {
    if (this.config.needsPointerData) {
      this.sendTouchEvent(event);
    }
  ...
  onPointerOutOfBounds(event, _sourceEvent) {
  ...
  onPointerMoveOver(_event, _sourceEvent) {// used only by hover gesture handler atm
  }

  onPointerMoveOut(_event, _sourceEvent) {// used only by hover gesture handler atm
  }
